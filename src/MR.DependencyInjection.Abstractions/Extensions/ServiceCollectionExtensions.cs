...
namespace MR.DependencyInjection.Abstractions.Extensions
{
			...
			ServiceDescriptor descriptor)
		{
				...
				implementationType == descriptor.ServiceType)
			{
				throw new ArgumentException(
					string.Format(Resources.TryAddIndistinguishableTypeToEnumerable, implementationType, descriptor.ServiceType),
					nameof(descriptor));
			}
